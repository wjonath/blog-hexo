...
tags:
  - shadowsocks
categories: []
date: 2018-05-14 05:24:00
---
### 梯子介绍
- 搬瓦工注册并购买主机: http://banwagong.cn/

- 主机管理地址：https://bwh1.net/clientarea.php

- 配置修改：
  - `/etc/shadowsocks-python/config.json`  
  - 操作命令：`/etc/init.d/shadowsocks-python status | restart | stop`

- 将以下内容保存为脚本 shadowsocks-all.sh，执行
